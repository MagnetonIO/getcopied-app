...
import { APP_VERSION, PKG_URL, RELEASES_URL } from "@/lib/version";
    ...
    <section className="pt-32 pb-20 px-6">
      ...
      >
        ...
        <motion.div variants={fadeUp} className="flex items-center justify-center gap-4">
          <a
            href={PKG_URL}
            onClick={() => trackDownload({ location: "hero", variant: "license", version: APP_VERSION })}
    ...
    <section id="download" className="py-24 px-6 bg-[var(--bg-secondary)]">
      ...
      >
        ...
        <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href={PKG_URL}
            onClick={() => trackDownload({ location: "download_section", variant: "license", version: APP_VERSION })}
